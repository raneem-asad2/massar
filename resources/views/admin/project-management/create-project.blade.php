        ...
        <form action="{{ route('admin.projects.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="robot_id" id="robot_id" class="form-control @error('robot_id') is-invalid @enderror" value="{{ old('robot_id') }}">
                    @error('robot_id')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="number" name="staff_id" id="staff_id" class="form-control @error('staff_id') is-invalid @enderror" value="{{ old('staff_id') }}">
                    @error('staff_id')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="assignment_date" id="assignment_date" class="form-control @error('assignment_date') is-invalid @enderror" value="{{ old('assignment_date') }}" required>
