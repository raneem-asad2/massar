...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <div class="auth-buttons ms-lg-3">
          @guest
              {{-- Show these buttons if the user is a GUEST --}}
          ...
          @else
              ...
              <div class="dropdown">
                  <a class="cta-btn dropdown-toggle" href="#" role="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                      {{ Auth::user()->name }}
                  </a>
  ...
  <main class="main">
      {{-- This is the placeholder for your page-specific content --}}
      @yield('content')
  </main>
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        ...
        <div class="col-lg-4 col-md-12 footer-newsletter">
          ...
          {{-- This form also needs a proper Laravel route and @csrf token to work --}}
  ...
  <!-- Vendor JS Files (CLEANED UP - NO DUPLICATES) -->
