...
<script>
    const barChart = new Chart(document.getElementById('barChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{ label: 'Tasks Completed', data: [3,5,2,6,4], backgroundColor: 'rgba(54,162,235,0.6)' }]
        },
    ...
    const donutChart = new Chart(document.getElementById('donutChart').getContext('2d'), {
        type: 'doughnut',
        data: { labels: ['Painting','Idle','Charging','Error'], datasets: [{ data: [3,1,1,1], backgroundColor: ['#28a745','#ffc107','#17a2b8','#dc3545'] }] },
        options: { responsive: true, maintainAspectRatio: false }
    });
    ...
    const batteryChart = new Chart(document.getElementById('batteryChart').getContext('2d'), {
        type: 'bar',
        data: { labels: ['Robot_01','Robot_02','Robot_03','Robot_04'], datasets: [{ label: 'Battery Level (%)', data: [85,45,22,77], backgroundColor: ['#17a2b8','#ffc107','#dc3545','#28a745'] }] },
        options: { responsive: true, maintainAspectRatio: false }
    });
</script>
@endsection
